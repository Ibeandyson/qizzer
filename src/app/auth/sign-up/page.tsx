      ...
      <chakra.div flexDir="row" justifyContent="center" alignItems="center" px={{base: '2.5rem', md: '7rem'}} minH="100vh">
        <chakra.div width="100%" height="100%">
          ...
          <Text fontSize="14px" fontWeight="400" textAlign="center" lineHeight="16.8px" mb="50px">
            Have an account?
            <span style={{color: 'purple', fontWeight: '500', marginLeft: '5px', cursor: "pointer"}}><Link href={'/auth/log-in'}>Login here</Link></span>
          </Text>

          <InputUI type="text" style={{marginBottom: '40px', marginTop: '20px'}} lable="First Name" value="" onchange={() => {}} placeHolder="" />
          <InputUI type="text" style={{marginBottom: '40px', marginTop: '20px'}} lable="Last Name" value="" onchange={() => {}} placeHolder="" />
          <InputUI type="email" style={{marginBottom: '40px', marginTop: '20px'}} lable="Email" value="" onchange={() => {}} placeHolder="" />
          <InputUI type="number" style={{marginBottom: '40px', marginTop: '20px'}} lable="Phone" value="" onchange={() => {}} placeHolder="" />
          ...
          <InputUI
            ...
            placeHolder=""
          />
          <ButtonUI label="Register" onClick={() => {}} />
          <Box width="fit">
