...
import { chakra, FormControl, FormLabel, Input, Button, Text, Image, Box, Heading, useToast } from '@chakra-ui/react';
        ...
        <chakra.div width="100%" height="100%">
          ...
          <chakra.div>
            ...
            <InputUI
              ...
              style={{ marginBottom: '40px', marginTop: '20px' }}
            />
            <ButtonUI loading={loading} label="Register" onClick={(e) => handleSubmit(e)} />
          </chakra.div>

          <Box width="fit">
            <chakra.div display="flex" justifyContent="space-between" alignItems="center" width="100%" my="15px">
              <Image width={{ base: '145px', md: '170px' }} height="20px" src="../imgs/Line1.svg" alt="line" />
